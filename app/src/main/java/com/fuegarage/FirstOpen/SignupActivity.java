    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        regBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if( email.isEmpty()||pickedImgUri==null|| name.isEmpty() || password.isEmpty()  || !password.equals(password2)) {

                    if(pickedImgUri==null ){
                        showMessage("choose your image") ;
                    }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if(user != null ){
                                String mUserUid = user.getUid().toString();
                                HashMap<String, Object> hashMap = new HashMap<>();
                                hashMap.put("uid",mUserUid);
                                hashMap.put("name",name);
                                hashMap.put("email",email);
                                hashMap.put("photo","photo");
                                hashMap.put("wallet",0);
                                hashMap.put("phone","1234560");

                                //hashMap.put("photo",imageFilePath.getDownloadUrl().toString());

                                DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("Users").child(mUserUid);
